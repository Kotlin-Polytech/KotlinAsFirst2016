 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int) = (sagenes*48*4.445+arshins*48/3*4.445+vershoks*4.445)/100
/**
 * Тривиальная
 *
 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int) = grad*(PI/180)+min*(PI/(180*60))+sec*(PI/(180*3600))
...
fun numberRevert(number: Int): Int {
    ...
    val secondDigit = number%100/10*10
