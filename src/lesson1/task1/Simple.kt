 ...
 */
fun seconds(h: Int, m: Int, s: Int): Int {
    val answer : Int = h * 3600 + m * 60 + s
    return answer
}
...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double {
    val answer : Double = (sagenes * 48 + arshins * 16 + vershoks) * 0.04445
    return answer
}
...
fun angleInRadian(grad: Int, min: Int, sec: Int): Double {
    val answer = grad * PI / 180 + min * PI / (180 * 60) + sec * PI / (180*3600)
    return answer
}
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val answer : Double = initial * pow(1 + percent * 0.01, 3.0)
    return answer
}
/**
 * Простая
