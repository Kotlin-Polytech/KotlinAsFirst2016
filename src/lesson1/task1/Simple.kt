 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = PI / (180 * 3600) * (grad* 3600 + min * 60 + sec )
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int {
    val n1 = hoursDepart * 60 + minutesDepart
    val n2 = hoursArrive * 60 + minutesArrive
    return n2 - n1
}
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val ey1 = (initial / 100.0) * percent + initial
    val ey2 = ey1 * percent / 100.0 + ey1
    val ey3 = ey2 * percent / 100.0 + ey2
    return ey3
}
