 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = ((sec / 60.0 + min) / 60.0 + grad) * PI / 180
 ...
 */
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double): Double = Math.sqrt(sqr(x2-x1) + sqr(y2-y1))
