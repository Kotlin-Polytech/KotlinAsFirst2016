 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = grad*Math.PI/180 +min*Math.PI/(180*60) + sec*Math.PI/(180*3600)
        /**
 * Тривиальная
 *
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int) = initial*(percent/100.0+1)*(percent/100.0+1)*(percent/100.0+1)
