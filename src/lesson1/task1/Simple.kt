 ...
 */
        fun angleInRadian(grad: Int, min: Int, sec: Int): Double = ( grad + ( min / 60.0 ) + ( sec / 3600.0 ) ) / 180.0 * 3.14
 ...
 */
        fun accountInThreeYears(initial: Int, percent: Int): Double = initial * ( 1.0 + ( percent / 100.0 ) ) * ( 1.0 + ( percent / 100.0 ) ) * ( 1.0 + ( percent / 100.0 ) ) * 1.0
