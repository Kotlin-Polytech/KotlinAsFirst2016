...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val firstyear = (initial * 110.0) / 100.0
    val secondyear = (firstyear * 110.0) / 100.0
    val thirdyear = (secondyear * 110.0) / 100.0
    return thirdyear
}
/**
 * Простая
...
fun numberRevert(number: Int): Int {
    val edin = (number % 10)              //единицы
    val des = (number / 10) % 10            //десятки
    val sotn = (number / 100)             //сотни
    return 100 * edin + 10 * des + sotn    //результат
