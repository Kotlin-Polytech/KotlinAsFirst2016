 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = (grad + min / 60.0 + sec / (60.0 * 60)) / (180 / PI)
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int {
    val timeDe = hoursDepart * 60 + minutesDepart
    val timeAr = hoursArrive * 60 + minutesArrive
    return timeAr - timeDe
}
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val totalPer = (1.0 + percent * 0.01) * (1.0 + percent * 0.01) * (1.0 + percent * 0.01)
