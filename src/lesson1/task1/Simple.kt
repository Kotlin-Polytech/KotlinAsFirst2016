 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int) = ((grad * 60 * 60 + min * 60 + sec) * 2 * PI) / (360 * 60 * 60)
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val growth = percent / 100.0 + 1
    val income = initial * growth * growth * growth
    return income
}
...
fun numberRevert(number: Int): Int {
    val numberConversely = number % 10 * 100 + number / 10 % 10 * 10 + number / 100 % 10
    return numberConversely
}
