 ...
 */
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double): Double = 1.0 * sqrt(sqr(x1 - x2) + sqr(y1 - y2))
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = (1.0 + 0.01 * percent) * (1.0 + 0.01 * percent) * (1.0 + 0.01 * percent) * initial
