 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = ((grad*3600+min*60+sec)*1.0)/(180.0/PI)/3600.0
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial*(100+percent)*(100+percent)*(100+percent)*0.000001
