 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = (Math.PI * (grad + min / 60.0 + sec / 3600.0)) / 180.0
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val escalationfactor = (percent / 100.0 + 1)
    val sum = initial * escalationfactor * escalationfactor * escalationfactor
    return sum
}
