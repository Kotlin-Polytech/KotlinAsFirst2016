 ...
 */
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int = (60-minutesDepart+minutesArrive+hoursArrive-hoursDepart-1)
 ...
 */
fun numberRevert(number: Int): Int = (number/100 + number/10%10 + number%10 * 100)
