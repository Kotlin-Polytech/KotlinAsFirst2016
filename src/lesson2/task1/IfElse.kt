...
fun ageDescription(age: Int): String {
    when {
        ...
        ((age / 10 >= 2) && (age % 10 in 2..4)) -> return "$age года"
        ((age / 10 < 1) && (age % 10 in 2..4)) -> return "$age года"
        ((age / 10 >= 2) && (age % 10 == 1) || (age == 1)) -> return "$age год"
        ((age / 10 < 1) && (age % 10 == 1) || (age == 1)) -> return "$age год"
    }
    return "$age лет"
}
