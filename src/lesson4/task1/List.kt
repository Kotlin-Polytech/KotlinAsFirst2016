...
fun russianThousands(n: Int): String {
    ...
    return if ((foo % 10) == 0 || (foo % 10) == 5) result + " тысяч" else if ((foo % 10) == 1) return result + " тысяча" else if ((foo % 100 > 10 ) && (foo % 100 < 20)) return result + " тысяч" else return result + " тысячи"
}
