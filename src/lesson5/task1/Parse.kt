...
fun plusMinus(expression: String): Int {
    ...
    if ((LengthOfString == 1) && ((members[0].contains(NotRightFormat)) || expression == "")) throw IllegalArgumentException("Wrong format expression")
    else {
        for (i in 0..LengthOfString - 2) {
            ...
            if (WrongString) throw IllegalArgumentException("Wrong format expression")
            else {
