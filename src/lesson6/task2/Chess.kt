...
data class Square(val column: Int, val row: Int) {
     ...
     */
    fun notation(): String {
        val listColumn = listOf(1 to "a", 2 to "b", 3 to "c", 4 to "d", 5 to "e", 6 to "f", 7 to "g", 8 to "h")
        if (inside() == true)
            return listColumn[column - 1].second + row
        else return ""
    }
}
...
fun square(notation: String): Square {
    if (notation[0] !in 'a'..'h' || notation[1] - '0' !in 1..8) throw IllegalArgumentException()
    return Square((notation[0] - 'a').toInt()+1, notation[1]-'0')
}
