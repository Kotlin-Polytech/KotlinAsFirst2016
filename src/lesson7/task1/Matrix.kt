...
fun <E> createMatrix(height: Int, width: Int, e: E): Matrix<E> {
    val err = IllegalArgumentException("Description")
    if (height <= 0 || width <= 0) throw err
...
class MatrixImpl<E>(override val height: Int, override val width: Int, e: E) : Matrix<E> {
    private val listMatrix = mutableListOf<E>()
    ...
    override fun get(row: Int, column: Int): E = listMatrix[row * width + column]
    override fun get(cell: Cell): E = get(cell.row, cell.column)

    override fun set(row: Int, column: Int, value: E) {
        listMatrix[row * width + column] = value
    }
    ...
    override fun toString(): String {
        ...
        sb.append("]")
        return sb.toString() // or, sb.toString()
    }

    override fun hashCode(): Int {
        var result = height
        result = 31 * result + width
        result = 31 * result + listMatrix.hashCode()
        return result
    }
}
