...
operator fun Matrix<Int>.unaryMinus(): Matrix<Int> {
    for (h in 0..this.height - 1)
        for (w in 0..this.width - 1)
            this[h, w] = -this[h, w]
    return this
}
...
operator fun Matrix<Int>.times(other: Matrix<Int>): Matrix<Int> {
    ...
    if (this.width != other.height) throw e
    val resultMatrix = createMatrix(this.height, other.width, 0)
    for (h in 0..this.height - 1)
        for (w in 0..other.width - 1)
            for (i in 0..other.height - 1)
                resultMatrix[h, w] += this[h, i] * other[i, w]
    return resultMatrix
}
