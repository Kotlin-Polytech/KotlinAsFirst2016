...
class Tests {
    ...
    fun factorize() {
        ...
        assertEquals(listOf(3, 17, 18461), factorize(941511))
    }
    ...
    fun convert() {
        ...
        assertEquals(listOf( 0 ), convert(0, 457))
    }
    ...
    fun convertToString() {
        ...
        assertEquals("0", convertToString(0, 19))
    }
    ...
    fun roman() {
        ...
        assertEquals("MMMMMCDII", roman(5402))
    }
