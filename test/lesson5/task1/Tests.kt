...
//    @Tag("Normal")
    fun dateStrToDigit() {
        ...
        assertEquals("21.03.0", dateStrToDigit("21 марта 0"))
    }
...
//    @Tag("Normal")
    fun dateDigitToStr() {
        ...
        assertEquals("21 марта 0", dateDigitToStr("21.03.0"))
    }
...
//    @Tag("Normal")
    fun bestLongJump() {
        ...
        assertEquals(2147483647, bestLongJump("1 - - 28091682 - - - 1087510185 % 2147483647 % 2124496172 0 - - - 2147483647 - % % % 2147483647 60649251 505117913 - 2147483647 % - % % 2058542539 - 1 - 446903569 % - 2147483647 2147483647 - - 1 % - % - % % - % 2105451378 0 - 0 % - % % - 874510054 - - 1802998794 % 673250986 241866140 - - % % % 1 0 1848998189 % - 878993426 % - 0 - 854408651 - 0 645542387 - % - % 2147483647 % - % 1 % % - - 2133609971 - - 2102449715 1 - - 0 % 2147483647 - 596628534 - - 1 % 0 - - 1871524478 %"))
    }
...
//    @Tag("Hard")
    fun mostExpensive() {
        ...
        assertEquals("Вино", mostExpensive("Вино 255.0; Просфора 0"))
    }
