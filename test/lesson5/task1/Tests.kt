...
class Tests {
    ...
    fun flattenPhoneNumber() {
        ...
        assertEquals("", flattenPhoneNumber("-- - -- - - - - - - - -- - ----- + 4 - 83-64---7 (- - 4 --8 56 1- -- 9 )--[ --1 , 8,---- - 0, -0, 8, -5, 7-, 7- -]"))
    }
    ...
    fun bestLongJump() {
        ...
        assertEquals(2147483647, bestLongJump("- - % 1720574432 - % 2147483647 - % 1077069672 1 - 2147483647 1870466310 1 1327691321"))
