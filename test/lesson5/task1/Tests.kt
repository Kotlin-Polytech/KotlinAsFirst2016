...
class Tests {
    ...
    @Tag("Hard")
    fun testFun(){
        assertEquals(listOf("1 x 5000", "2 x 1000", "1 x 500", "1 x 100", "3 x 10", "1 x 2", "1 x 1", "2 x 0.10", "1 x 0.01" ), change(7633.21, "5000, 1000, 500, 100, 50, 10, 5, 2, 1, 0.50, 0.10, 0.05, 0.01"))
        assertEquals(listOf("1 x 5000", "4 x 1000", "2 x 100", "4 x 10", "1 x 5", "1 x 0.10"), change(9245.10, "5000, 1000, 500, 100, 50, 10, 5, 2, 1, 0.50, 0.10, 0.05, 0.01"))
        assertEquals(listOf("3 x 10", "1 x 0.10"), change(30.10, "5000, 1000, 500, 100, 50, 10, 5, 2, 1, 0.50, 0.10, 0.05, 0.01"))
        assertEquals(listOf("1 x 5000", "1 x 3000", "2 x 500", "2 x 100", "4 x 10", "1 x 5", "1 x 0.10"), change(9245.10, "5000, 3000, 500, 100, 50, 10, 5, 2, 1, 0.50, 0.10"))
    }
}