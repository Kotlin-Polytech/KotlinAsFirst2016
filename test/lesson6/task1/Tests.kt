...
class Tests {
    ...
    fun diameter() {
        ...
        val p7 = Point(-999.9770974044369, -632.0)
        val p8 = Point(-999.7517133809476, -1000.0)
        val p9 = Point(-632.0, -999.7791156308923)
        assertEquals(Segment(p7, p9), diameter(p7,p8,p9))
        assertEquals(520.2582263726694, diameter(p7, p8, p9).length(), 1e-10)
