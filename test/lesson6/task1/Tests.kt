...
class Tests {
    ...
    fun circleByThreePoints() {
        ...
        val customCirle = circleByThreePoints(Point(1.0, 0.0), Point(0.0, 1.0), Point(-1.0, 0.0))
        assertTrue(customCirle.center.distance(Point(0.0,0.0)) < 1e-5)
        assertEquals(1.0, customCirle.radius, 1e-5)
    }
