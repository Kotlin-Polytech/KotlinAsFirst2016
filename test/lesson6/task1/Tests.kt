...
class Tests {
    ...
    fun bisectorByPoints() {
        ...
        assertEquals(Line(Point(-999.573989990775, -815.8820674605879), 3.1392759010487357), bisectorByPoints( Point(-999.14797998155, -632.0), Point(-1000.0, -999.7641349211759)))
    }
