...
class Tests {
    ...
    @Test
    fun equals() {
        assertEquals(createMatrix(1, 1, listOf(listOf(3))), equals(createMatrix(1, 1, listOf(listOf(3)))))
        assertEquals(createMatrix(2, 2, listOf(listOf(1, 2), listOf(2, 2))), equals(createMatrix(1, 1, listOf(listOf(1, 2), listOf(2, 2)))))
    }
}