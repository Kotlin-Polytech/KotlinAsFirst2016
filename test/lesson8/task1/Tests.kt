...
разработки.""")
    ...
    fun countSubstrings() {
        ...
        assertEquals(mapOf("бвбУ" to 8, "баДбвбюббЩбГвЁбрШЩ" to 6, "ЦааУМэбюаббРвбвабб" to 8, "бв" to 40, "Габбг" to 12, "бЙввэюббфАбабщПввъбЫ" to 12, "габб" to 20, "ЕП" to 6, "ШавГЩ" to 8, "абба" to 8, "Фбввдва" to 8, "ааебб" to 10),
                countSubstrings("input/f.txt", listOf("бвбУ", "баДбвбюббЩбГвЁбрШЩ", "ЦааУМэбюаббРвбвабб", "бв", "Габбг", "бЙввэюббфАбабщПввъбЫ", "габб", "ЕП", "ШавГЩ", "абба", "Фбввдва", "ааебб")))
        assertEquals(mapOf("брФКввЁЭаТ" to 6, "бв" to 45, "ОЙвва" to 4, "аабвавЬмабввуву" to 6, "бвабшфабвбб" to 11, "ПаббиЧбвЬИжкУбТфьбэ" to 6, "бё" to 2, "Зв" to 2, "вбЯфаЪвэЕб" to 2, "бУбба" to 2),
                countSubstrings("input/x.txt", listOf("брФКввЁЭаТ", "бв", "ОЙвва", "аабвавЬмабввуву", "бвабшфабвбб", "ПаббиЧбвЬИжкУбТфьбэ", "бё", "Зв", "вбЯфаЪвэЕб" , "бУбба")))
